...
The p-value (0.00443) for F statistics is still less than our significance level, so we reject the null hypothesis again. Mean ages of acquisition of different classes are not the same.
...
ggplot(target_cats_new, aes(Lex_cat, AoA, color = Lex_cat)) + 
    ...
    theme_bw() + 
   ggtitle("POS acquisition")+
    xlab('POS')+
    ylab('age in months') + scale_colour_discrete("POS")
