...
According to this information, the author decided to analyze *common nouns*, *places to go* and *people* as nouns, *action words* as verbs, *descriptive words* as adjectives and *closed-class* as closed class words. The reason of this choice is that mixed categories are able to confuse models and results. Additional relevant factors for the paper are frequencies of words in adults’ and child directes speech and age of reproducing each word.
...
The pictures below provide general information about each learned word and age of its acquisition.
...
The main hypotheses of the piece of research are that children commence to reproduce words of closed class after acquisition of nouns, verbs and adjectives and frequency of words in child directed speech and adults’ speech within some classes have strong correlation with age of acquisition. The statistical hypotheses based on the linguistic ones are:
...
* __H0__: there appears to be no correlation/no linear negative or positive association between frequencies of categories in parents’ speech and age of words' acquisition, the true correlation coefficient R is 0.
* __H1__: there appears to be correlation/linear negative or positive association between frequencies of categories in parents’ speech and age of words' acquisition, the true correlation coefficient R is not 0.
...
Estimates of **Main factors** part, some categories of words are not named as 
...
The p-value (<2e-16) for F statistics is less than our significance level, so we reject the null hypothesis. Mean ages of acquisition of different classes are not the same.
...
The p-value (<2e-16) for F statistics is still less than our significance level, so we reject the null hypothesis again. Mean ages of acquisition of different classes are not the same.
